...
// Images
import SignInUrl from "../../assets/images/signIn.png";
...
const SignInPage = () => {
  ...
  const { isSignIned, isError, isLoading } = selector
          ...
          >
            ...
            <FormGroup>
              <div className="d-flex justify-content-between align-items-center">
                ...
                <span style={{ color: "#7367F0", fontSize: "12px" }}>
                  Forgot Password?
                </span>
              </div>
              <InputComponent
            ...
            <FormGroup check>
              <Input type="checkbox" id="remember" /> <Label for="remember" check>Remember me</Label>
            </FormGroup>
            {isError && <span style={{color: 'red', fontSize: 12}}>User name or password is wrong</span>}
            <Button
              className="mt-2"
              style={{
            ...
            >
              <span style={{ color: "#6E6B7B" }}>New on our platform? </span>
              <span style={{ color: "#7367F0",cursor: 'pointer' }} onClick={() => navigate('/signup')}>Create an account</span>
            </div>
